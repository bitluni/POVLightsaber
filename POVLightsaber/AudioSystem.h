...
class SoundBase
{
  ...
  void remove(SoundBase **prevNext)
  {
    *prevNext = next;
    delete this;
  }

  void insert(SoundBase **prevNext)
  {
    next = *prevNext;
    *prevNext = this;
  }
